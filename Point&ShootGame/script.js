...
class Raven {
    constructor(){
        ...
        this.hasTrail = Math.random() > 0.5; //a number between zero and one, return true or false if number is more or less than 0.5
...
function animate(timestamp){
    ...
    lastTime = timestamp;
    timeToNextRaven += deltatime; // increase 16,000,000
